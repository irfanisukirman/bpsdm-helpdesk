...
@section('content')
    ...
    <p>Kami informasikan bahwa tiket Anda dengan nomor
        <strong style="color:#008a41;">{{ $ticket->ticket_number }}</strong>
    ...
    <p style="margin:24px 0;">
        <a href="{{ route('track.form') }}" style="background:#008a41;color:#ffffff;text-decoration:none;padding:12px 22px;border-radius:6px;display:inline-block;">Lihat Detail Penyelesaian</a>
    </p>
